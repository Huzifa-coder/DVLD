...
namespace DVLD_SE.Licenses.Detain_License
{
    public partial class frmDetainLicenseApplication : Form
    {
        ...
        private void btnDetain_Click(object sender, EventArgs e)
        {
            ...
            _DetainID = ctrlDriverLicenseFilter1.SelectedLicenseInfo.Detain(Convert.ToSingle(txtFineFees.Text), clsGlobal.CurrentUser.UserID);
            if (_DetainID == -1)
            {
        ...
        private void ctrlDriverLicenseInfoWithFilter1_OnLicenseSelected(int obj)
        {
            ...
            if (ctrlDriverLicenseFilter1.SelectedLicenseInfo.IsDetained)
            {
